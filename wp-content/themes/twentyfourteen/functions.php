...
function change_default_title( $title ){
        ...
        switch ($screen->post_type) {
                case "machines":
                        return 'Enter Service Tag Here. i.e. HY7645J';
                        break;
                case "customers":
                        return 'Enter Customer License Name Here';
                        break;
                case "manakins":
                        return 'Enter Manakin Identifier Here';
                        break;
                case "systems":
                        return 'Enter Heart Works Identifier Here. i.e. HW0045';
                        break;
        }
}
